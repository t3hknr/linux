...
FULL_PROXY_FUNC(splice_read, ssize_t, filp,
		PROTO(struct file *filp, loff_t *ppos, struct pipe_inode_info *pipe, size_t len, unsigned int flags),
		ARGS(filp, ppos, pipe, len, flags));
